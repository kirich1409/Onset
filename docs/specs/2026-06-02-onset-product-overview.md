...
- [x] **РЕШЕНО** Эвристика авто-формата камеры (#145): дефолт — предпочитать 16:9, целевое разрешение Full HD (≤1080p): наибольший 16:9-формат с высотой ≤1080 и fps≥30; если все 16:9 выше 1080p — наименьший из них; при отсутствии 16:9 — фолбэк на наибольшее по пикселям. Поверх дефолта — ручной выбор (#113, Phase 2). Явный выбор формата — post-MVP (Phase 2).
