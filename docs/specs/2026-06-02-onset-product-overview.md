...
- [`onset-devops-ci`](2026-06-02-onset-devops-ci.md) — инфраструктура вокруг кода: двухскоростной CI (быстрый PR-гейт + async-слой), auto-merge, L5 на self-hosted, security-проверки. Прямой ответ на требование fast feedback для agent-driven модели.
