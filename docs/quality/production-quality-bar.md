...
**Последнее обновление:** 2026-06-08 (v0.4)
**Владелец:** @kirich1409
**Статус критериев:** черновик (v0.4) — добавлен §3.6 покрытие кода (L2, информационно); ярусная матрица устройств (Tier 0 / Tier 1), встроенный дисплей MacBook, graceful-поведение при отсутствии внешних устройств
